...
<?php
session_start();
if((($_SESSION['user']!="") && ($_SESSION['category']=="employer") &&  ($_SESSION['role']=="Admin")) || (($_SESSION['user']!="") && (($_SESSION['category']=="senior" && $_SESSION['role']=="Cashier") || ($_SESSION['category']=="junior") && $_SESSION['role']=="Cashier" )))
{
    function MNTH($mnth)
{
    if($mnth=="January")
